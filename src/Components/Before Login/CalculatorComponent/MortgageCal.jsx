...
function LoanCalculator() {
    ...
    const handleOnChange = (event) =>{
        ...
        setInitialValues((values)=>({
            ...
            console.log(parseInt(InitialValues.ROI))
    ...
    const Calculate = () =>{
        ...
        let ROIVal = (parseFloat(InitialValues.ROI)/100)/12
        let TermVal = parseFloat(InitialValues.Term)*12
        let amount = (PrincipalVal * ROIVal * (1+ROIVal)**TermVal / [(1+ROIVal)**TermVal-1])
        setDisplay((""))
        setInitialValue({
    ...
    return(
        ...
        <div style={{display:Display}} className='card justify-content-center text-start p-4'>
            <div><h2>Calculating</h2></div>
            <div><h3>House Price {InitialValues.principalAmount}</h3></div>
            <div><h3>Duration {InitialValues.Term}</h3></div>
            <div><h3>Rate Of Interest {InitialValues.ROI}</h3></div>
        </div>
        
        <div className='card text-center container w-50'>
            <form action="">
                <dl>
                    <dt className='mt-3'> <h3> House Price </h3></dt>
                    ...
                    <dt className='mt-3'> <h3> Rate Of Interest </h3></dt>
                    ...
                    <dt className='mt-3'> <h3> Number Of Years </h3></dt>
        ...
        <div style={{display:Display}} className='card justify-content-center text-start p-4'>
            ...
            <div><h3>Total Interest <span className='' style={{color:"#E57C23"}}>{M - InitialValue.principalAmount }</span></h3></div>
            <div><h3>Total Amount Payable: <span style={{color:"#E57C23"}}>{M}</span></h3></div>
        </div>
